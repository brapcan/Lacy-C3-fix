...
BLOCKS = {  #######################
            ...
            ###################
                    ...
                    'ammonium':{'mass':18.033825466812,
                        ...
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_ammonium':{'mass':9.520550966812,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_sodium':{'mass':11.998522873856,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_potassium':{'mass':19.985491573406,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'sodium_potassium':{'mass':30.97673798045,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'sodium_3x_2':{'mass':33.981015687944,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'potassium_sodium_2x_2':{'mass':41.967984387494,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'sodium_4x_2':{'mass':44.972262094988,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_proton_ammonium':{'mass':6.68279280014533,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_proton_sodium':{'mass':8.334774071508,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_proton_potassium':{'mass':13.659419871208,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_sodium_sodium':{'mass':15.662271676204,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_sodium_potassium':{'mass':20.986917475904,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_sodium_3x_3':{'mass':22.9897692809,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'proton_potassium_sodium_2x_3':{'mass':28.3144150806,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'sodium_4x_3':{'mass':30.317266885596,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
                        'oxygens':0,
                        'sulfurs':0},
                    'potassium_sodium_3x_3':{'mass':35.641912685296,
                        'available_for_charge_carrier':1,
                        'carbons':0,
                        'hydrogens':0,
                        'nitrogens':0,
...
class App():
    ...
    def outputPopup(self,master):
        ...
        self.chargeState = Checkbutton(top, text = "\u00B9Intensities per Charge State", variable = master.analytePerCharge, onvalue = 1, offvalue = 0)
        self.chargeState.grid(row = 2, column = 1, sticky = W)
        self.bckSub = Checkbutton(top, text = "\u00B2Background subtracted Intensities", variable = master.analyteBckSub, onvalue = 1, offvalue = 0)
        self.bckSub.grid(row = 3, column = 1, sticky = W)
        self.norClus = Checkbutton(top, text = "\u00B3Normalization per cluster", variable = master.normalizeCluster, onvalue = 1, offvalue = 0)
